...
namespace aice_stable.commands
{
    ...
    public class MusicCommandModule : BaseCommandModule
    {
        ...
        // [Command("save_beta"), Description("Save the current playlist to the database.")]
        // public async Task CreatePlaylistAsync(CommandContext context, [RemainingText] String name) {
